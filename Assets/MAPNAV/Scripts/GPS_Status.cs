...
public class GPS_Status : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (info)
        {
			...
			GUI.Label(new Rect(screenX/40, screenY/50, screenX-screenX/20, screenY/50), "Latitude: " + gps.userLat, style);
			GUI.Label(new Rect(screenX/40, 3*screenY/50, screenX-screenX/20, screenY/50), "Longitude: " + gps.userLon, style);
			//GUI.Label(new Rect(screenX/40, 5*screenY/50, screenX-screenX/20, screenY/50), "Altitude(m): " + altitude, style);
			GUI.Label(new Rect(screenX/40, 5*screenY/50, screenX-screenX/20, screenY/50), "BUSES: " + BusUpdater.testBuses, style);
